...
@property (nonatomic,assign) BOOL useKeychainPersistence;
@property (nonatomic,assign) BOOL useSessionPersistence;
...
@property (nonatomic,retain,readonly) NSString *authenticationRealm;
@property (nonatomic,retain,readonly) NSString *proxyAuthenticationRealm;
...
@property (nonatomic,retain) NSMutableArray *requestCookies;
@property (nonatomic,retain,readonly) NSArray *responseCookies;
@property (nonatomic,assign) BOOL useCookiePersistence;
@property (nonatomic,retain) NSDictionary *requestCredentials;
@property (nonatomic,retain) NSDictionary *proxyCredentials;
@property (nonatomic,assign,readonly) int responseStatusCode;
@property (nonatomic,retain,readonly) NSString *responseStatusMessage;
@property (nonatomic,retain,readonly) NSMutableData *rawResponseData;
...
@property (nonatomic,assign) unsigned long long postLength;
@property (nonatomic,assign) BOOL shouldResetDownloadProgress;
@property (nonatomic,assign) BOOL shouldResetUploadProgress;
@property (nonatomic,assign) ASIHTTPRequest *mainRequest;
@property (nonatomic,assign) BOOL showAccurateProgress;
@property (nonatomic,assign,readonly) unsigned long long totalBytesRead;
@property (nonatomic,assign,readonly) unsigned long long totalBytesSent;
@property (nonatomic,assign) NSStringEncoding defaultResponseEncoding;
@property (nonatomic,assign,readonly) NSStringEncoding responseEncoding;
...
@property (nonatomic,assign) BOOL didCreateTemporaryPostDataFile;
@property (nonatomic,assign) BOOL useHTTPVersionOne;
@property (nonatomic,assign, readonly) unsigned long long partialDownloadSize;
...
@property (nonatomic,retain) NSURL *PACurl;
@property (nonatomic,retain) NSString *authenticationScheme;
@property (nonatomic,retain) NSString *proxyAuthenticationScheme;
@property (nonatomic,assign) BOOL shouldPresentAuthenticationDialog;
@property (nonatomic,assign) BOOL shouldPresentProxyAuthenticationDialog;
@property (nonatomic,assign, readonly) ASIAuthenticationState authenticationNeeded;
@property (nonatomic,assign) BOOL shouldPresentCredentialsBeforeChallenge;
@property (nonatomic,assign, readonly) int authenticationRetryCount;
@property (nonatomic,assign, readonly) int proxyAuthenticationRetryCount;
@property (nonatomic,assign) BOOL haveBuiltRequestHeaders;
@property (assign, nonatomic) BOOL haveBuiltPostBody;
@property (nonatomic,assign, readonly) BOOL isSynchronous;
...
@property (nonatomic,assign) BOOL shouldAttemptPersistentConnection;
@property (nonatomic,assign) NSTimeInterval persistentConnectionTimeoutSeconds;
@property (nonatomic,assign) BOOL shouldUseRFC2616RedirectBehaviour;
@property (nonatomic,assign, readonly) BOOL connectionCanBeReused;
@property (nonatomic,retain, readonly) NSNumber *requestID;
@end
