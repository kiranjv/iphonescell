...
@property (nonatomic,retain) NSMutableData *rawResponseData;
...
@property (nonatomic,assign, nonatomic) unsigned long long lastBytesRead;
@property (nonatomic,assign, nonatomic) unsigned long long lastBytesSent;
@property (nonatomic,retain) NSRecursiveLock *cancelledLock;
@property (nonatomic,retain, nonatomic) NSOutputStream *fileDownloadOutputStream;
@property (nonatomic,assign) int authenticationRetryCount;
@property (nonatomic,assign) int proxyAuthenticationRetryCount;
...
@property (nonatomic,retain) NSString *authenticationRealm;
@property (nonatomic,retain) NSString *proxyAuthenticationRealm;
@property (nonatomic,retain) NSString *responseStatusMessage;
@property (nonatomic,assign) BOOL isSynchronous;
@property (nonatomic,assign) BOOL inProgress;
@property (nonatomic,assign) int retryCount;
@property (nonatomic,assign) BOOL connectionCanBeReused;
@property (retain, nonatomic) NSMutableDictionary *connectionInfo;
@property (retain, nonatomic) NSInputStream *readStream;
@property (nonatomic,assign) ASIAuthenticationState authenticationNeeded;
