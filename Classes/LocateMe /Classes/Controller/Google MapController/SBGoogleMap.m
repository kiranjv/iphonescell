...
//@synthesize imgString = mimgString;
...
-(IBAction)backToCategoryDesc:(id)sender{
...
- (void)viewDidLoad {
    ...
    [backButton setFrame:CGRectMake(10, 5, 24, 24)];
    ...
    [pinButton setFrame:CGRectMake(80, 5, 70, 24)];
    [pinButton setBackgroundImage:[UIImage imageNamed:@"backbtn.png"] forState:UIControlStateNormal];
    [pinButton setBackgroundImage:[UIImage imageNamed:@"landbackbtn.png"] forState:UIControlStateHighlighted];
    [pinButton setBackgroundImage:[UIImage imageNamed:@"landbackbtn.png"] forState:UIControlStateSelected];
    [pinButton addTarget:self action:@selector(loadRouteAnnotations) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:pinButton];
    
    UIButton *goButton=[UIButton  buttonWithType:UIButtonTypeCustom];
    [goButton setFrame:CGRectMake(160, 5, 70, 24)];
    [goButton setBackgroundImage:[UIImage imageNamed:@"backbtn.png"] forState:UIControlStateNormal];
    [goButton setBackgroundImage:[UIImage imageNamed:@"landbackbtn.png"] forState:UIControlStateHighlighted];
    [goButton setBackgroundImage:[UIImage imageNamed:@"landbackbtn.png"] forState:UIControlStateSelected];
    [goButton addTarget:self action:@selector(showCheckpoints) forControlEvents:UIControlEventTouchUpInside];
    ...
    if (interfaceOrientation == UIInterfaceOrientationPortrait ||interfaceOrientation == UIInterfaceOrientationPortraitUpsideDown){
         ...
         self.map = [[SBMapView alloc] initWithFrame:CGRectMake(0, 35, 320, 425)];
        
    }
    else
    {
        self.map = [[SBMapView alloc] initWithFrame:CGRectMake(0, 35, 480, 300)];
