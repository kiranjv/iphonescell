...
@property (nonatomic,assign) SEL requestDidReceiveResponseHeadersSelector;
@property (nonatomic,assign) SEL requestDidFinishSelector;
@property (nonatomic,assign) SEL requestDidFailSelector;
@property (nonatomic,assign) SEL queueDidFinishSelector;
@property (nonatomic,assign) BOOL shouldCancelAllRequestsOnFailure;
@property (nonatomic,assign) id delegate;
@property (nonatomic,assign) BOOL showAccurateProgress;
@property (nonatomic,assign, readonly) int requestsCount;
@property (nonatomic,retain) NSDictionary *userInfo;

@property (nonatomic,assign) unsigned long long bytesUploadedSoFar;
@property (nonatomic,assign) unsigned long long totalBytesToUpload;
@property (nonatomic,assign) unsigned long long bytesDownloadedSoFar;
@property (nonatomic,assign) unsigned long long totalBytesToDownload;
